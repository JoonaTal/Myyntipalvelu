...
import { useRouter, useSearchParams } from "next/navigation"; // Ensure you're using next/navigation for client-side routing
...
const Page = () => {
  ...
  const { mutate: signIn, isLoading, isError, error } =
  ...
  const onSubmit = (data: TAuthCredentialsValidator) => {
    signIn(data); //data = email, password
  };
      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
        ...
        <div className="grid gap-6">
          ...
          <div className="relative">
            <div
              aria-hidden="true"
              className="absolute inset-0 flex flex-center"
            >
