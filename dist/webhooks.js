...
var stripeWebHookHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var webhookRequest, body, signature, event, session, payload, users, user, orders, order, userEmail, orderId, data, error_1, errorMessage;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 5:
                ...
                orderId = typeof session.metadata.orderId === 'string' ? session.metadata.orderId : '';
