...
var get_payload_1 = require("../get-payload"); //Server-side eli ei absoluuttista tietä = "@"
    ...
    createSession: trpc_1.privateProcedure
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    result = _c.sent();
                    products = result.docs.filter(isProduct);
                ...
                case 3:
                    ...
                    filteredProducts.forEach(function (product) {
                        line_items.push({
                            price: product.priceId, // Assert that priceId is a string
                            quantity: 1,
                        });
                    });
                    line_items.push({
                ...
                case 4:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                            success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=orderId=").concat(order.id),
