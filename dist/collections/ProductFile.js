...
var yourOwnPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
...
exports.ProductFiles = {
    ...
    upload: {
        ...
        mimeTypes: ["image/*", "font/*", "application/postscript"], //font ja postscript valinnaisia
    },
    fields: [
        {
            name: "user",
